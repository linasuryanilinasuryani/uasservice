...
Route::group(['prefix' => 'v1'], function() {
    ...
    Route::post('guru/{id}', [GuruController::class,'store']);
    ...
    Route::post('matapelajaran/{id}', [MataPelajaranController::class,'store']);
    Route::patch('matapelajaran/{id}', [MataPelajaranController::class, 'update']);
    Route::delete('matapelajaran/{id}', [MataPelajaranController::class, 'delete']);

    Route::get('pengampu', [PengampuController::class,'index']);
    Route::post('pengampu/{id}', [PengampuController::class,'store']);
    Route::patch('pengampu/{id}', [PengampuController::class, 'update']);
    Route::delete('pengampu/{id}', [PengampuController::class, 'delete']);
